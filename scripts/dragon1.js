...
function upgradeDragon(x) {
  if (x == 1 && game.gold.gte(2500000)) {
    ...
    document.getElementById("dragonInfo").innerHTML = "Your cactus king embodies death itself. It seems you have killed Death and taken his place as the taker of souls."
    game.dragonStage = 10
  }
...
function dragonPet() {
  if (game.dragonPets == 0 && game.cyanSigils.gte(250)) {
    ...
    game.dragonPets++
    document.getElementById("dragonPetButton").innerHTML = "You have petted your cactus king sufficiently."
